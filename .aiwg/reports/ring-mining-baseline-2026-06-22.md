...
**Source workspace:** `/Users/user/ring`  
**Target integration home:** `/Users/user/my-aiwg`  
...
Read-only inspection of `/Users/user/ring` showed:
...
- Do not archive, reset, delete, or mutate `/Users/user/ring`.
