...
const CONTEXT_CONTRACTS: Record<Platform, ProviderContextContract> = {
  ...
  dsh: {
    startupFiles: ['AGENTS.md'], precedence: ['provider/system', 'root-to-cwd AGENTS chain', 'nearest file'],
    loadMode: 'prose-directive', includeSyntax: null, configRegistration: null,
    bootstrapTargets: ['AGENTS.md'], maxContextBytes: null, recommendedMaxLines: 200, nestedContext: true, support: 'supported',
    verification: { method: 'harness source of record: workspace AGENTS.md is loaded into the system prompt (packages/core system-prompt; root CLAUDE.md symlinks AGENTS.md)', source: 'https://github.com/deepseek-ai/deepseek-harness', lastVerified: VERIFIED_ON },
  },
  generic: {
