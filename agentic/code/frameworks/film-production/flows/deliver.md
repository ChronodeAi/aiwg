...
type: flow
name: film-deliver
description: Film deliver lifecycle phase with evidence-based exit criteria.
---
# Film Deliver

## Entry
Current edit passed review and requested delivery specification is known.

## Activities
Export and inspect actual file; package captions/stems/project references as required, source hashes and residuals. Separate delivery from publication. Mine escaped defects.

Load with `aiwg show skill <name>`: film-delivery, film-retrospective.
