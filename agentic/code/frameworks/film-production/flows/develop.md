...
type: flow
name: film-develop
description: Film develop lifecycle phase with evidence-based exit criteria.
---
# Film Develop

## Entry
A user brief or clear continuation; applicable source/context available.

## Activities
Define audience, premise, causal beat chain, character knowledge and exact lines; audition performance timing before dependent generation. Bound reference research to decisions.

Load with `aiwg show skill <name>`: film-intake, film-story-proof.
