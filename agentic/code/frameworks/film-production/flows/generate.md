...
type: flow
name: film-generate
description: Film generate lifecycle phase with evidence-based exit criteria.
---
# Film Generate

## Entry
Exact input versions pass applicable checks; operation and cost fall within recorded authority.
