...
The `{context_block}` is a ~300-word compressed summary of whatever the user is analyzing the announcement against — a business, product, codebase, personal project, role, etc. See SKILL.md Step 2 for how it gets built.
