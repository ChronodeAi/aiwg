...
> **External skill** — Source: [https://github.com/soleio/luck](https://github.com/soleio/luck) by soleio. Not maintained by prodmgmt.world. Run `./external-skills/update.sh` to pull the latest version.
