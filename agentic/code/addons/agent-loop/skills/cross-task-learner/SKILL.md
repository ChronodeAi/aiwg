...
- `@$AIWG_ROOT/agentic/code/addons/agent-loop/schemas/shared-patterns.yaml` - Pattern schema
- `@$AIWG_ROOT/agentic/code/addons/agent-loop/schemas/cross-task-memory.yaml` - Cross-task memory
- `@$AIWG_ROOT/agentic/code/addons/agent-loop/docs/cross-loop-learning.md` - Full documentation
...
- @$AIWG_ROOT/agentic/code/addons/agent-loop/README.md — Ralph addon overview
- @$AIWG_ROOT/agentic/code/addons/agent-loop/schemas/shared-patterns.yaml — Pattern schema for cross-loop learning
- @$AIWG_ROOT/agentic/code/addons/agent-loop/schemas/cross-task-memory.yaml — Cross-task memory schema
- @$AIWG_ROOT/agentic/code/addons/agent-loop/docs/cross-loop-learning.md — Full cross-loop learning documentation
