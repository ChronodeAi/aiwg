...
- @$AIWG_ROOT/agentic/code/addons/agent-loop/docs/executable-feedback-guide.md - Guide
- @$AIWG_ROOT/agentic/code/addons/agent-loop/schemas/debug-memory.yaml - Memory schema
