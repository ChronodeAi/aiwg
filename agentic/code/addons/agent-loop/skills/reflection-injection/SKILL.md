...
3. **Format for injection**:
   ...
   - Use @$AIWG_ROOT/agentic/code/addons/agent-loop/templates/self-reflection-prompt.md template
...
- @$AIWG_ROOT/agentic/code/addons/agent-loop/schemas/reflection-memory.json - Schema
- @$AIWG_ROOT/agentic/code/addons/agent-loop/docs/reflection-memory-guide.md - Guide
- @$AIWG_ROOT/agentic/code/addons/agent-loop/templates/self-reflection-prompt.md - Prompt template
