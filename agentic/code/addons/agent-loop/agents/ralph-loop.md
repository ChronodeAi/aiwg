...
- @$AIWG_ROOT/agentic/code/addons/agent-loop/schemas/reflection-memory.json — Episodic reflection memory schema (REF-021)
- @$AIWG_ROOT/agentic/code/addons/agent-loop/schemas/cross-task-memory.yaml — Cross-task learning patterns with Ω presets
- @.aiwg/ralph/reflections/index.yaml — Auto-populated reflection index
- @$AIWG_ROOT/agentic/code/addons/agent-loop/docs/reflection-memory-guide.md — Comprehensive reflection memory guide

## References

- @.aiwg/ralph/ - Al workspace and state
- @$AIWG_ROOT/agentic/code/addons/agent-loop/docs/ - User documentation
- @$AIWG_ROOT/agentic/code/addons/agent-loop/commands/ralph-reflect.md — View and manage reflections
- @$AIWG_ROOT/agentic/code/addons/agent-loop/skills/reflection-injection/SKILL.md — Auto-inject past reflections
- @$AIWG_ROOT/agentic/code/addons/agent-loop/hooks/post-iteration-reflect.md — Generate reflections after iterations
- @$AIWG_ROOT/agentic/code/addons/agent-loop/templates/self-reflection-prompt.md — Prompt template for reflection injection
