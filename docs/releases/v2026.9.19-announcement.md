...
- **Post-publish evidence:** The tag-bound publisher invoked the fail-closed
  Socket audit directly, but the v2026.9.19 run failed its exact-source binding
  because the caller supplied the annotated tag object rather than the peeled
  release commit. v2026.9.20 carries the corrected binding.
