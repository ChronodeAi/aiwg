...
| DeepSeek Harness | `~/.agents/skills/` (skills; honors `DSH_AGENTS_HOME`); skills are the only mirrored artifact | **Verified** against DSH source of record (`packages/skill/skill-filesystem` USER_AGENTS scan root) |
