...
stable_id: aiwg.agent-reference.context-regeneration
---

# Context Regeneration Guide

> **Audience: agents, scripts, and advanced operators.** General users should
> ask their agent to refresh project context and use
> [Install and Repair Commands](install-and-repair.md) only when the agent is
> unavailable.
