...
| Codex | AIWG startup-listing cap (deploy) | 8,000 chars | `--listing-cap <chars>` or `AIWG_CODEX_LISTING_CAP` (`0` disables) |
| Codex | `aiwg doctor` diagnostic cap | 8,000 chars | `codex.skillListingCharCap` in `.aiwg/aiwg.config` (raise to `25000` for larger kernel listings) |
...
| AIWG doctor diagnostic cap | 8,000 chars | Project override: `codex.skillListingCharCap` in `.aiwg/aiwg.config` |
