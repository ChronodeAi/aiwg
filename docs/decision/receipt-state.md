...
|---|---|---|
| acquired | dispatched, composed, failed, execution-uncertain | Ownership exists; no adapter call has started. |
...
| observation-received | dispatched, composed, failed, execution-uncertain | One adapter observation has returned; another bounded attempt may begin. |
